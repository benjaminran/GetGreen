...
public class NoteStatistics extends DescriptiveStatistics implements Comparable<NoteStatistics> {
    ...
    public double getSpread() {
        return ((double) getCentsIQR()) / 100.0;
    }
    ...
    public Pitch getQ1() {
        return Pitch.fromFrequency(getPercentile(25));
    }

    public Pitch getQ2() {
        return Pitch.fromFrequency(getPercentile(50));
    }

    public Pitch getQ3() {
        return Pitch.fromFrequency(getPercentile(75));
    }
}
